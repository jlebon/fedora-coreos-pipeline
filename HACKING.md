...
Developer-specific resources will be prefixed by the current user's
username. You can provide `--prefix` to override this default.

You may also want to provide additional switches depending on the
circumstances. For example, to target specific pipeline, FCOS config,
cosa image, or bucket:
